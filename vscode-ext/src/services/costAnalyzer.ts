 ...
 *
 * VS Code extension edition — mirrors src/services/costAnalyzer.ts in the
 * CCLens CLI package; keep the parsing logic in sync with the CLI.
 *
...
export async function analyzeCosts(
	...
	for (const file of files) {
		...
		await parseSessionFile(file, projectName, pricing, report);
	}
